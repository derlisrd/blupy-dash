...
function ModalFicha() {
    ...
    const onClose = ()=>{ setModals({...modals,ficha:false}); setDatos(initialDatos) }
    ...
    return ( <Modal isOpen={modals.ficha} onClose={onClose}>
        <ModalOverlay />
        <ModalContent>
          ...
          <ModalBody>
            {
              ...
              <Stack direction='column'>
                ...
                <Image
                    boxSize='360px'
                    objectFit='cover'
                    src={env.PUBLIC_PATH+`/${datos?.foto_ci_frente}`}
                    alt='Frontal'
                  />
              </Stack>
            }
