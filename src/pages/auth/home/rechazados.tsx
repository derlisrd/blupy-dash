            ...
            <Card>
                ...
                <CardBody>
                    <Flex direction='row'  gap='2' alignItems='center' >
                        ...
                        <Text fontSize='2xl' as='samp' >{datosTotales.rechazadosHoy}</Text>
                    </Flex>
                </CardBody>
            </Card>
        </GridItem>
        <GridItem w='100%'>
            <Card>
                ...
                <CardBody>
                    <Flex direction='row'  gap='2' alignItems='center' >
                    <NotAllowedIcon boxSize={6} color='tomato' />
                        <Text fontSize='2xl' as='samp' >{datosTotales.rechazadosSemana}</Text>
                    </Flex>
                </CardBody>
            </Card>
        </GridItem>
        <GridItem w='100%'>
            <Card>
                ...
                <CardBody>
                    <Flex direction='row'  gap='2' alignItems='center' >
                    <NotAllowedIcon boxSize={6} color='tomato' />
                        <Text fontSize='2xl' as='samp' >{datosTotales.rechazadosMes}</Text>
                    </Flex>
                </CardBody>
            </Card>
        </GridItem>
        <GridItem w='100%'>
            <Card bgColor='#FED7D7'>
                ...
                <CardBody>
                    <Flex direction='row'  gap='2' alignItems='center' >
                    <NotAllowedIcon boxSize={6} color='tomato' />
                        <Text fontSize='2xl' as='samp' >{datosTotales.solicitudesRechazadas}</Text>
                    </Flex>
                </CardBody>
            </Card>
        </GridItem>
