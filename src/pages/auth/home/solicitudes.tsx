            ...
            <Card>
                ...
                <CardBody>
                    <Flex direction='row'  gap='2' alignItems='center' >
                        ...
                        <Text fontSize='2xl' as='samp' >{datosTotales.solicitudesHoy}</Text>
                    </Flex>
                </CardBody>
            </Card>
        </GridItem>
        <GridItem w='100%'>
            <Card>
                ...
                <CardBody>
                    <Flex direction='row'  gap='2' alignItems='center' >
                        <InfoIcon boxSize={6} color='#3182CE' />
                        <Text fontSize='2xl' as='samp' >{datosTotales.solicitudesSemana}</Text>
                    </Flex>
                </CardBody>
            </Card>
        </GridItem>
        <GridItem w='100%'>
            <Card>
                ...
                <CardBody>
                    <Flex direction='row'  gap='2' alignItems='center' >
                        <InfoIcon boxSize={6} color='#3182CE' />
                        <Text fontSize='2xl' as='samp' >{datosTotales.solicitudesMes}</Text>
                    </Flex>
                </CardBody>
            </Card>
        </GridItem>
        <GridItem w='100%'>
            <Card bgColor='#BEE3F8'>
                ...
                <CardBody>
                    <Flex direction='row'  gap='2' alignItems='center' >
                    <InfoIcon boxSize={6} color='#3182CE' />
                        <Text fontSize='2xl' as='samp' >{datosTotales.solicitudesTotales}</Text>
                    </Flex>
                </CardBody>
            </Card>
        </GridItem>
