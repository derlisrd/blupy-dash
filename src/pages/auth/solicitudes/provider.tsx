...
export const SolicitudesContext = createContext<solicitudesTypes>({
    ...
    lista: [],
    setLista:()=>{},
    form: { estado_id:0, funcionario:0, id: null, name:'', celular:'',cedula:'',cliente_id:'',estado:'',tipo:0,email:'', asofarma:0,user_id:0,foto_ci_frente:'',solicitud_credito:0,codigo:""},
    setForm: ()=>{},
    getListaCB:()=>{}
})
...
function SolicitudesProvider({children}:Props) {
    ...
    const initialForm : userForm = { estado_id:0, funcionario:0, id: null, name: '', celular:'',cedula:'',cliente_id:'',tipo:0,estado:'',email:'', asofarma:0,user_id:0, foto_ci_frente:'',solicitud_credito:0,codigo:""}
