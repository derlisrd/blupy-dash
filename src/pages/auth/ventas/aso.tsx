          ...
          <CardBody>
            <Flex direction="row" gap="2" alignItems="center">
              ...
              <Text fontSize="xl" as="samp">
                {ventasTotales.importeTotalAyerAso.toLocaleString("es-PY")}
              </Text>
            </Flex>
          </CardBody>
        </Card>
        ...
        <Card>
          ...
          <CardBody>
            <Flex direction="row" gap="2" alignItems="center">
              ...
              <Text fontSize="xl" as="samp">
                {ventasTotales.importeTotalSemanaAso.toLocaleString("es-PY")}
              </Text>
            </Flex>
          </CardBody>
        </Card>
        ...
        <Card>
          ...
          <CardBody>
            <Flex direction="row" gap="2" alignItems="center">
              ...
              <Text fontSize="xl" as="samp">
                {ventasTotales.importeTotalMesAso.toLocaleString("es-PY")}
              </Text>
            </Flex>
          </CardBody>
        </Card>
