          ...
          <CardBody>
            <Flex direction="row" gap="2" alignItems="center">
              ...
              <Text fontSize="xl" as="samp">
                {ventasTotales.importeTotalAyerDigital.toLocaleString("es-PY")}
              </Text>
            </Flex>
          </CardBody>
        </Card>
        ...
        <Card>
          ...
          <CardBody>
            <Flex direction="row" gap="2" alignItems="center">
              ...
              <Text fontSize="xl" as="samp">
                {ventasTotales.importeTotalSemanaDigital.toLocaleString("es-PY")}
              </Text>
            </Flex>
          </CardBody>
        </Card>
        ...
        <Card>
          ...
          <CardBody>
            <Flex direction="row" gap="2" alignItems="center">
              ...
              <Text fontSize="xl" as="samp">
                {ventasTotales.importeTotalMesDigital.toLocaleString("es-PY")}
              </Text>
            </Flex>
          </CardBody>
        </Card>
