          ...
          <CardBody>
            <Flex direction="row" gap="2" alignItems="center">
              ...
              <Text fontSize="xl" as="samp">
                {formatNumberString(ventasTotales.importeTotalAyerDigital)}
              </Text>
            </Flex>
          </CardBody>
        </Card>
        ...
        <Card>
          ...
          <CardBody>
            <Flex direction="row" gap="2" alignItems="center">
              ...
              <Text fontSize="xl" as="samp">
                {formatNumberString(ventasTotales.importeTotalSemanaDigital)}
              </Text>
            </Flex>
          </CardBody>
        </Card>
        ...
        <Card>
          ...
          <CardBody>
            <Flex direction="row" gap="2" alignItems="center">
              ...
              <Text fontSize="xl" as="samp">
                {formatNumberString(ventasTotales.importeTotalMesDigital)}
              </Text>
            </Flex>
          </CardBody>
        </Card>
